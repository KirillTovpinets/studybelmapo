<?php 
  function makeDeduct($data, $courses, $mysqli){
    $doc_body = "";
    ...
    <link rel=File-List href=\"приказ%20об%20окончании.files/filelist.xml\">
    ...
    <!--[if gte mso 9]><xml>
     <o:DocumentProperties>
      ...
      <o:LastPrinted>2018-04-06T06:42:00Z</o:LastPrinted>
      <o:Created>2018-05-17T08:49:00Z</o:Created>
      <o:LastSaved>2018-05-17T08:49:00Z</o:LastSaved>
      <o:Pages>3</o:Pages>
      <o:Words>631</o:Words>
      <o:Characters>3597</o:Characters>
    ...
    <link rel=themeData href=\"приказ%20об%20окончании.files/themedata.thmx\">
    <link rel=colorSchemeMapping
    href=\"приказ%20об%20окончании.files/colorschememapping.xml\">
    <!--[if gte mso 9]><xml>
     <w:WordDocument>
    ...
    .MsoChpDefault
     ...
     /* Page Definitions */
     @page
        {mso-footnote-separator:url(\"приказ%20об%20окончании.files/header.htm\") fs;
        mso-footnote-continuation-separator:url(\"приказ%20об%20окончании.files/header.htm\") fcs;
        mso-endnote-separator:url(\"приказ%20об%20окончании.files/header.htm\") es;
        mso-endnote-continuation-separator:url(\"приказ%20об%20окончании.files/header.htm\") ecs;}
    @page WordSection1
        ...
        mso-title-page:yes;
        mso-even-header:url(\"приказ%20об%20окончании.files/header.htm\") eh1;
        mso-header:url(\"приказ%20об%20окончании.files/header.htm\") h1;
        mso-even-footer:url(\"приказ%20об%20окончании.files/header.htm\") ef1;
        mso-footer:url(\"приказ%20об%20окончании.files/header.htm\") f1;
        mso-first-header:url(\"приказ%20об%20окончании.files/header.htm\") fh1;
        mso-first-footer:url(\"приказ%20об%20окончании.files/header.htm\") ff1;
        mso-paper-source:0;}
    div.WordSection1
        {page:WordSection1;}
     /* List Definitions */
    ...
    <p class=MsoNormal style='line-height:14.0pt;mso-line-height-rule:exactly'><span
    style='font-size:14.0pt'>Об окончании слушателями<o:p></o:p></span></p>
    
    <p class=MsoNormal style='line-height:14.0pt;mso-line-height-rule:exactly'><span
    style='font-size:14.0pt'>повышения<span style='mso-spacerun:yes'> 
    </span>квалификации<o:p></o:p></span></p>
    ...
    <p class=MsoNormal style='text-align:justify;text-indent:35.4pt'><span
    style='font-size:14.0pt'>В соответствии с подпунктом 2.1 пункта 2 статьи 79
    Кодекса Республики Беларусь об образовании, в связи с выполнением учебных
    планов и программ повышения квалификации и по результатам успешной аттестации<o:p></o:p></span></p>
    ...
    for($i = 0; $i < count($courses); $i++){
        ...
        $doc_body .= "<p class=MsoNormal style='text-align:justify'><a name=first></a><span
        style='font-size:14.0pt'><span style='mso-tab-count:1'>         </span>1.<span
        style='mso-spacerun:yes'>  </span>Отчислить из числа слушателей группы № $number $typeRelForm
        &laquo;$courseName&raquo; ($notes) на кафедре $cathedraName согласно списку:<o:p></o:p></span></p>";


        $doc_body .= "<table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0 style='border-collapse:collapse;mso-yfti-tbllook:1184;mso-padding-alt:0cm 5.4pt 0cm 5.4pt'>";
         ...
         for($k = 0; $k < count($budgetList); $k++){
            ...
            $doc_body .= "<tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;page-break-inside:avoid'>
                            ...
                            <p class=MsoNormal style='tab-stops:17.85pt'><span style='font-size:14.0pt'>$index. $person<o:p></o:p></span></p>
                            </td>
                            <td width=215 valign=top style='width:161.4pt;padding:0cm 5.4pt 0cm 5.4pt'>
        ...
        for($k = 0; $k < count($payfulList); $k++){
            ...
            $doc_body .= "<tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;page-break-inside:avoid'>
                            ...
                            <td width=215 valign=top style='width:161.4pt;padding:0cm 5.4pt 0cm 5.4pt'>
                            <p class=MsoNormal style='text-align:justify'><span style='font-size:14.0pt'>платное
                            Д № $contractNumber<o:p></o:p></span></p>
                            </td>
                        </tr>";
            $index++;
        }   
    ...
    $doc_body .= "<p class=MsoNormal style='text-align:justify;text-indent:35.4pt'><span
    style='font-size:14.0pt'>$numParagraph. Выпуск<span style='mso-spacerun:yes'> 
    </span>слушателей провести<span style='mso-spacerun:yes'>  </span>06.04.2018.<o:p></o:p></span></p>";
    $numParagraph = $numParagraph + 1;
        
    $doc_body .= "<p class=MsoNormal style='text-align:justify'><span style='font-size:14.0pt'><span
    style='mso-tab-count:1'>         </span>$numParagraph. Начальнику учебно-организационного<span
    style='mso-spacerun:yes'>  </span>отдела<span style='mso-spacerun:yes'>   
    </span>Морозовой О.Н. обеспечить <span style='mso-spacerun:yes'>  </span>выдачу
    <span style='mso-spacerun:yes'> </span>свидетельств <span
    style='mso-spacerun:yes'> </span>о повышении квалификации установленного<span
    style='mso-spacerun:yes'>  </span>образца.<o:p></o:p></span></p>";
