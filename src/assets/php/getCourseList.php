<?php 
	...
	if (isset($_GET["year"])) {
        ...
        $limit = $_GET["limit"];
        $offset = $_GET["offset"];
        $query = "SELECT cources_zip.id, cources_zip.Number, cources_zip.name, cources_zip.Start, cources_zip.Finish, cources_zip.Notes FROM cources_zip WHERE cources_zip.year = $year ORDER BY cources_zip.Number ASC LIMIT $limit OFFSET $offset";
